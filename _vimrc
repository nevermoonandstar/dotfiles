...
if has("gui_running")
    colorscheme solarized " downloaded theme
    set background=dark " dark by default anyway, noted in case
    set colorcolumn=+1 " highlight the first column beyond the textwidth
else
    colorscheme earth
    set colorcolumn=""
endif
